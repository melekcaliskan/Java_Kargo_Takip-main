...
<%
    ...
    ResultSet rs = null;
        ...
        String subeSorgusu = "SELECT isim FROM kullanici WHERE eposta = ?";
...
<div class="main">
   ...
   <table id="kargoTablosu">
    ...
    <%
        ...
        String sql = "SELECT * FROM kargo WHERE teslim_eden = ? ORDER BY id DESC";
        PreparedStatement stmt = conn.prepareStatement(sql);
        stmt.setString(1, isim); // Değişken adı düzeltildi
